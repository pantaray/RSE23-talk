...
def compute_connectome(subIdx):
      ...
      # Save result
      np.save("con_{}".format(subIdx), estimator.covariance_)
      return
...
#SBATCH --array=1-40        # Define job-array
...
```{.python data-id="code2" style="font-size: 0.8em; "}
def compute_connectome(subIdx):
...
if __name__ == "__main__":
      ...
      with ParallelMap(compute_connectome, range(40) as pmap:
